...
ptt: false, seconds: 3596400,contextInfo: {
 ...
 mediaUrl: 'https://instagram.com/shendyeditz?igshid=YmMyMTA2M2Y=',
    ...
    title: "⌫     ⌨︎     ☏︎",
    body: wm,
    thumbnail: await (await fetch('https://i.ibb.co/CWx7LWQ/20221114-123229.jpg')).buffer(),
  ...
  conn.send2ButtonVid(m.chat, `https://api.lolhuman.xyz/api/tiktokwm?apikey=${lolkey}&url=${args[0]}`, txt, wm, `No Wm`, `.tiktoknowm ${args[0]}`, `Audio`, `.ttmp3 ${args[0]}`, m)
    }
}
